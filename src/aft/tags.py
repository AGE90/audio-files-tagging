...
class AudioTags:
    ...
    def _load_file(self) -> bool:
        ...
        except (MutagenError, OSError, IOError) as e:
    ...
    def _read_mp4_tags(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'bpm': str(get_tag('tmpo', 0)),
            'key': str(get_tag('----:com.apple.iTunes:initialkey', b'')),
            'publisher': get_tag('----:com.apple.iTunes:LABEL'),
            'catalog_number': get_tag('----:com.apple.iTunes:CATALOGNUMBER'),
    ...
    def write_tags(self, metadata: Dict[str, Any]) -> bool:
        ...
        except (MutagenError, OSError, IOError, ValueError) as e:
...
def read_audio_tags(file_path: Union[str, Path]) -> Dict[str, Any]:
    """
...
def write_audio_tags(file_path: Union[str, Path], metadata: Dict[str, Any]) -> bool:
    """
